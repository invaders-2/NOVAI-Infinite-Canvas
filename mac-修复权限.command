...
xattr -r -d com.apple.quarantine 启动.command 2>/dev/null
xattr -r -d com.apple.quarantine install.command 2>/dev/null
...
# 设置执行权限
chmod +x 启动.command 2>/dev/null
chmod +x install.command 2>/dev/null
